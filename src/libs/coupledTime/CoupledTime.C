...
namespace Foam
{
    defineTypeNameAndDebug(CoupledTime, 0);
}

const Foam::Enum
<
    Foam::CoupledTime::stopAtControls
>
Foam::CoupledTime::stopAtControlNames
({
...
const Foam::Enum
<
    Foam::CoupledTime::writeControls
>
Foam::CoupledTime::writeControlNames
({
...
Foam::CoupledTime::fmtflags Foam::CoupledTime::format_(Foam::CoupledTime::general);

int Foam::CoupledTime::precision_(6);

const int Foam::CoupledTime::maxPrecision_(3 - log10(SMALL));

Foam::word Foam::CoupledTime::controlDictName("controlDict");

int Foam::CoupledTime::printExecutionFormat_
(
...
(
    ...
    int,
    Foam::CoupledTime::printExecutionFormat_
);


// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

void Foam::CoupledTime::adjustDeltaT()
{
...
void Foam::CoupledTime::initiatMUI()
{
...
void Foam::CoupledTime::setControls()
{
...
void Foam::CoupledTime::setMonitoring(const bool forceProfiling)
{
...
Foam::autoPtr<Foam::CoupledTime> Foam::CoupledTime::New()
{
    return
        autoPtr<CoupledTime>::New
        (
            fileName("."),  // root-path
            fileName("."),  // case-name
...
Foam::autoPtr<Foam::CoupledTime> Foam::CoupledTime::New(const fileName& caseDir)
{
    return
        autoPtr<CoupledTime>::New
        (
...
Foam::autoPtr<Foam::CoupledTime> Foam::CoupledTime::New(const argList& args)
{
    return
        autoPtr<CoupledTime>::New
        (
            CoupledTime::controlDictName,
            args,
            false,          // No enableFunctionObjects
            false           // No enableLibs
        );
...
Foam::word Foam::CoupledTime::timeName(const scalar t, const int precision)
{
...
Foam::word Foam::CoupledTime::timeName() const
{
    return dimensionedScalar::name();
}


Foam::word Foam::CoupledTime::findInstance
(
    const fileName& dir,
    const word& name,
...
Foam::word Foam::CoupledTime::findInstancePath
(
...
Foam::word Foam::CoupledTime::findInstancePath(const instant& t) const
{
    return findInstancePath(path(), t);
}


Foam::label Foam::CoupledTime::startTimeIndex() const
{
    return startTimeIndex_;
}


Foam::dimensionedScalar Foam::CoupledTime::startTime() const
{
    return dimensionedScalar("startTime", dimTime, startTime_);
}


Foam::dimensionedScalar Foam::CoupledTime::endTime() const
{
    return dimensionedScalar("endTime", dimTime, endTime_);
}


Foam::CoupledTime::stopAtControls Foam::CoupledTime::stopAt() const
{
    return stopAt_;
}


bool Foam::CoupledTime::run() const
{
    loopProfiling_.reset(nullptr);
    ...
    if (isRunning)
    {
        if (!subCycling_)
        {
            const_cast<CoupledTime&>(*this).readModifiedObjects();
        ...
        if (profiling::active())
        {
            ...
            (
                new profilingTrigger("CoupledTime.run() " + objectRegistry::name())
            );
        }
    }
...
bool Foam::CoupledTime::end() const
{
    return value() > (endTime_ + 0.5*deltaT_);
}


bool Foam::CoupledTime::stopAt(const stopAtControls stopCtrl) const
{
...
bool Foam::CoupledTime::isAdjustTimeStep() const
{
    return controlDict_.getOrDefault("adjustTimeStep", false);
}


void Foam::CoupledTime::setTime(const CoupledTime& t)
{
    value() = t.value();
...
void Foam::CoupledTime::setTime(const instant& inst, const label newIndex)
{
    value() = inst.value();
...
void Foam::CoupledTime::setTime(const dimensionedScalar& newTime, const label newIndex)
{
    setTime(newTime.value(), newIndex);
}


void Foam::CoupledTime::setTime(const scalar newTime, const label newIndex)
{
    value() = newTime;
...
void Foam::CoupledTime::setEndTime(const dimensionedScalar& endTime)
{
    setEndTime(endTime.value());
}


void Foam::CoupledTime::setEndTime(const scalar endTime)
{
    endTime_ = endTime;
}


void Foam::CoupledTime::setDeltaT
(
...
void Foam::CoupledTime::setDeltaT(const scalar deltaT, const bool adjust)
{
    deltaT_ = deltaT;
    deltaTchanged_ = true;
...
Foam::CoupledTimeState Foam::CoupledTime::subCycle(const label nSubCycles)
{
    #ifdef FULLDEBUG
    if (prevTimeState_)
    {
...
void Foam::CoupledTime::subCycleIndex(const label index)
{
...
void Foam::CoupledTime::endSubCycle()
{
    if (subCycling_)
    {
...
Foam::CoupledTime& Foam::CoupledTime::operator+=(const dimensionedScalar& deltaT)
{
    return operator+=(deltaT.value());
}


Foam::CoupledTime& Foam::CoupledTime::operator+=(const scalar deltaT)
{
    setDeltaT(deltaT);
    return operator++();
}
...
Foam::CoupledTime& Foam::CoupledTime::operator++()
{
...
Foam::CoupledTime& Foam::CoupledTime::operator++(int)
{
    return operator++();
}
