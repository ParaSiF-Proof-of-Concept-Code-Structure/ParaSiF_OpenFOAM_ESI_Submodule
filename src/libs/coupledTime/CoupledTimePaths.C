...
bool Foam::CoupledTimePaths::detectProcessorCase()
{
    if (processorCase_)
    {
...
Foam::CoupledTimePaths::CoupledTimePaths
(
    const argList& args,
...
Foam::instantList Foam::CoupledTimePaths::findTimes
(
...
Foam::instantList Foam::CoupledTimePaths::times() const
{
    return findTimes(path(), constant());
}


Foam::label Foam::CoupledTimePaths::findClosestTimeIndex
(
...
Foam::instant Foam::CoupledTimePaths::findClosestTime(const scalar t) const
{
