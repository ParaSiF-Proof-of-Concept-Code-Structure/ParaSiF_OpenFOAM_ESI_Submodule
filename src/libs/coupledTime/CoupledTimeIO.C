...
void Foam::CoupledTime::readDict()
{
    word application;
...
void Foam::CoupledTime::readModifiedObjects()
{
    if (runTimeModifiable_)
    {
...
bool Foam::CoupledTime::writeTimeDict() const
{
...
bool Foam::CoupledTime::writeObject
(
...
bool Foam::CoupledTime::writeNow()
{
    writeTime_ = true;
    return write();
}
...
bool Foam::CoupledTime::writeAndEnd()
{
    stopAt_  = saWriteNow;
    endTime_ = value();
...
void Foam::CoupledTime::writeOnce()
{
    writeOnce_ = true;
}


Foam::Ostream& Foam::CoupledTime::printExecutionTime(OSstream& os) const
{
